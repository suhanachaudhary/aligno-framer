...
const SplashScreen = () => {
    ...
    return (
        <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute top-10% left-0 w-[700px] h-[600px] bg-[#0D5EA6] opacity-20 blur-[60px] z-0"></div>
            <div className="absolute top-10% right-0 w-[600px] h-[600px] bg-[#0D5EA6] opacity-20 blur-[50px] z-0"></div>
